...
description: 'Use :focus-visible for modern CSS focus states so keyboard users keep clear rings and mouse users avoid unwanted click outlines.'
tags:
  - CSS
  - modern CSS
  - accessibility
...
pubDate: 'Nov 18 2024'
heroImage: '/focus.png'
socialImage: '/social/blog/css-focus-hack.png'
