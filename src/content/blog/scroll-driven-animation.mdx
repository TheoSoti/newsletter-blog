...
description: 'Scroll-driven animations connect CSS animation progress to scroll position, a modern CSS pattern for reveals, timelines, and sticky effects.'
tags:
  - CSS
  - modern CSS
...
socialImage: '/social/blog/scroll-driven-animation.png'
