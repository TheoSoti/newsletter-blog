---
title: 'Learn Modern CSS Container Queries for Adaptive Layouts'
description: 'Use container queries to build modern CSS components that respond to their own space, not only the viewport, with layouts you can reuse.'
tags:
  - CSS
  - modern CSS
  - container queries
...
socialImage: '/social/blog/container-queries.png'
...
import BuyBook from '../../../src/components/BuyBook.astro';
