...
description: 'Animate dynamic height in modern CSS without max-height hacks, using patterns that fit accordions, drawers, and expanding content.'
tags:
  - CSS
  - modern CSS
  - CSS animations
...
socialImage: '/social/blog/height-transition.png'
