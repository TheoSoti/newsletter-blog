...
description: 'CSS Height Transitions: 5 ways to smoothly transition height, from max-height to flexbox, grid, & new features like calc-size().'
pubDate: 'Oct 22 2024'
...
## Introduction to height transitions
