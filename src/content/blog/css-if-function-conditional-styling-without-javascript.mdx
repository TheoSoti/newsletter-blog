...
On June 23, 2026, [Can I Use reports 65.31% global support for CSS `if()`](https://caniuse.com/css-if), using May 2026 StatCounter data. Support starts in Chrome and Edge 137. Safari and Firefox do not support it yet.
