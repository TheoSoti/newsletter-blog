...
description: 'A modern CSS guide to Anchor Positioning for popovers, tooltips, and dropdowns without getBoundingClientRect, scroll listeners, or layout JavaScript.'
tags:
  - CSS
  - modern CSS
