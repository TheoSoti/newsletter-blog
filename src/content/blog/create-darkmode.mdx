---
title: 'Create a darkmode component'
description: 'Learn how to implement a simple and effective dark mode using CSS variables and minimal JavaScript. This guide walks you through the steps to add dark mode, make it persist using localStorage, and respect system preferences for a better user experience.'
pubDate: 'Sep 30 2024'
...
Dark mode is becoming more and more common across the web.<br/>
...
Giving users the choice of display helps make their experience more comfortable and personalized.
...
We we'll need a **checkbox** and **some content**.
...
Now we have our HTML and CSS variables set up, but we still miss the main part: the dark mode.<br/>
...
With just that addition, clicking the dark mode checkbox will switch the declared colors.<br />
...
Currently, if we check the dark mode checkbox and reload the page, it will reset to its original state.
...
To take it a step further, you can implement **prefers-color-scheme**, which will automatically apply the user's preferred mode based on their system settings.
