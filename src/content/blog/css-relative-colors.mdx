---
title: 'CSS Relative Colors: Build Palettes Without Color Pickers'
description: 'CSS relative colors turn one base color into hover states, borders, shadows, and accents, a practical modern CSS pattern for UI systems.'
tags:
  - CSS
  - modern CSS
  - CSS colors
...
socialImage: '/social/blog/css-relative-colors.png'
