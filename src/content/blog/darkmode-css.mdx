...
description: 'Build an accessible dark mode toggle with modern CSS, system preference support, and no JavaScript for the core theme switch.'
tags:
  - CSS
  - modern CSS
  - accessibility
...
socialImage: '/social/blog/darkmode-css.png'
