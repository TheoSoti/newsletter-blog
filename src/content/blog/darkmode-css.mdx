...
description: 'Learn how to implement a simple dark mode using CSS variables and minimal JavaScript. This guide walks you through the steps to add dark mode, make it persist using localStorage for a better user experience.'
pubDate: 'Sep 30 2024'
heroImage: '/darkmode.png'
readingTime: '5 min read'
---

## How to implement a darkmode
...
This method uses 3 simple principles :
