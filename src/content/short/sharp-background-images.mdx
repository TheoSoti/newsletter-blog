...
description: 'Serve sharp, responsive backgrounds using CSS image-set(). Let browsers choose the right asset for retina or standard screens. Lightweight, fast, and supported by 96% of browsers.'
